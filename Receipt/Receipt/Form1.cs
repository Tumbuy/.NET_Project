...
namespace Reciept
{
    public partial class Form1 : Form
    {
        ...
        private void btnAddItem_Click(object sender, EventArgs e)
        {
            ...
            if (txtName.Text == "")
            {
                MessageBox.Show("Enter Name of Product");
                
            }
           else if (txtPrice.Text == "")
            {
                MessageBox.Show("Enter Price value.\nType 0 if Free");
        ...
        private void btnPrintReciept_Click(object sender, EventArgs e)
        {
            if (txtCash.Text == "")
            {
                MessageBox.Show("Enter Cash value");
                return;
            }
            if (txtCompany.Text == "")
            {
        ...
        public void CreateReceipt(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            graphic.DrawString(txtCompany.Text, new Font("Courier New", 18), new SolidBrush(Color.Black), startX, startY);
